...
class MainWindow(wx.Frame):
    ...
    def OnOpen(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            # Set the file content to our text control
        ...
        # Inform the user that everything went OK in loading the file

        dlg = wx.MessageDialog(self, message='File imported correctly', caption='Information',
